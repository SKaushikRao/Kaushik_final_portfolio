...
import { FaReact, FaNodeJs, FaGithub, FaAws, FaPython, FaLinkedin, FaEnvelope, FaPhone } from 'react-icons/fa';
import { SiExpress, SiMongodb, SiTailwindcss, SiFigma, SiGreensock, SiThreedotjs, SiJavascript, SiMaterialdesign, SiTensorflow, SiGooglecloud } from 'react-icons/si';
...
const skills = [
    ...
    { name: "TensorFlow", icon: <SiTensorflow className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 sm:row-span-2 row-span-1" },
    { name: "Google Cloud", icon: <SiGooglecloud className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
